...
return var_hist.y   
elseif var_hist.find_hist_over == "Each column" && var_hist.normalized == false && var_hist.running == true 
...
elseif var_hist.find_hist_over == "Entire input" && var_hist.normalized == true && var_hist.running == true 
...
elseif var_hist.find_hist_over == "Each column" && var_hist.normalized == true && var_hist.running == true
  if (var_hist.reset_port == "Either edge" &&
    ((var_hist.prv_rst == 0 && rst !=0) || (var_hist.prv_rst != 0 && rst == 0))) ||
